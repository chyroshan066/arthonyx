                        ...
                        <div className="flex flex-wrap mt-0 -mx-3">
                            <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div className="flex mb-2">
                                    <div className="flex items-center justify-center w-5 h-5 mr-2 text-center bg-center rounded fill-current shadow-soft-2xl bg-gradient-soft-purple-pink text-neutral-900">
                                        <svg
                                            width="10px"
                                            height="10px"
                                            viewBox="0 0 40 44"
                            ...
                            <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div className="flex mb-2">
                                    <div className="flex items-center justify-center w-5 h-5 mr-2 text-center bg-center rounded fill-current shadow-soft-2xl bg-gradient-soft-blue600-cyan400 text-neutral-900">
                                        <svg
                                            width="10px"
                                            height="10px"
                                            viewBox="0 0 40 40"
                            ...
                            <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div className="flex mb-2">
                                    <div
                                        className="flex items-center justify-center w-5 h-5 mr-2 text-center bg-center rounded fill-current shadow-soft-2xl bg-gradient-soft-red500-yellow400 text-neutral-900">
                                        <svg
                                            width="10px"
                                            height="10px"
                                            viewBox="0 0 43 36"
                                    ...
                                    <p
                                        className="mt-1 mb-0 text-xs font-semibold leading-tight">
                                        Sales
                                    </p>
                                </div>
                            ...
                            <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div className="flex mb-2">
                                    <div
                                        className="flex items-center justify-center w-5 h-5 mr-2 text-center bg-center rounded fill-current shadow-soft-2xl bg-gradient-soft-red600-rose400 text-neutral-900">
                                        <svg
                                            width="10px"
                                            height="10px"
                                            viewBox="0 0 40 40"
